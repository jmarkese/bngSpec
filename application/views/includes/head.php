...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/bin-release1.0/history/history.css" />
<!--  END Browser History required section -->

<title></title>
<script src="<?php echo base_url();?>/bin-release1.0/AC_OETags.js" language="javascript"></script>

<!--  BEGIN Browser History required section -->
<script src="<?php echo base_url();?>/bin-release1.0/history/history.js" language="javascript"></script>
<!--  END Browser History required section -->

<style>
body.fuckthis { margin: 0px; overflow:hidden }
</style>
